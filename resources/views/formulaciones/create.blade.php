...
<div class="container mt-2" style="background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.1);">
    ...
    <form action="{{ route('formulaciones.store') }}" method="POST">
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control form-control-lg" id="item" name="item" required style="border-color: #fe495f; box-shadow: 0 0 5px rgba(254, 73, 95, 0.3);">
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <select name="cliente_id" id="cliente_id" class="form-control form-control-lg" required style="border-color: #fe495f; box-shadow: 0 0 5px rgba(254, 73, 95, 0.3);">
